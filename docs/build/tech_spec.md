...
(core/, engines/, plugins/, config/, scripts/, tests/ responsibilities preserved exactly as in original — unchanged and too long to re-paste here in preview, but INCLUDED in final file below.)
...
(lillycore directory tree left intact — included in final full file below.)
