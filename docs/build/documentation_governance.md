...
blocks:
  ...
  - id: docs_gov.overview
    ...
    tags: [docs, governance, canonical, mandatory_load]
    md: |
  ...
  - id: docs_gov.layers.build_system_docs
    ...
    applies_to: [architect, implementer, qa]
    tags: [docs, layers, build_system, canonical]
    md: |
  ...
  - id: docs_gov.layers.system_conceptual
    kind: layer
    name: System-Level Conceptual Docs
    applies_to: [architect, implementer, qa]
    tags: [docs, layers, conceptual]
    md: |
  ...
  - id: docs_gov.layers.plugin_docs
    kind: layer
    name: Plugin-Specific Docs
    applies_to: [architect, implementer, qa]
    tags: [docs, layers, plugins]
    md: |
  ...
  - id: docs_gov.layers.runtime_artefacts
    kind: layer
    name: Runtime-Generated Artefacts
    applies_to: [architect, implementer, qa]
    tags: [docs, layers, runtime]
    md: |
  ...
  - id: docs_gov.categories
    kind: rules
    applies_to: [architect, implementer, qa]
    tags: [docs, categories, requirements]
    md: |
      ## Doc Categories & Requirements
  ...
  - id: docs_gov.new_doc_types.criteria
    kind: rules
    applies_to: [architect, implementer, qa]
    tags: [docs, governance, new_doc_types]
    md: |
      ## Criteria for Introducing New Document Types
