...
#
# Architect GPT uses this to:
#   - Keep subsystems distinct.
#   - Place new features in the right engine or plugin.
#
# QA GPT uses this to verify that implemented work respects module boundaries and responsibilities.
#
# Implementer GPT uses this for:
...
#
# GPT RULE:
#   - If adding or changing an entry, follow this template.
#   - If unsure whether something deserves its own entry, ASK Andrew.
...
# ========================================
# SECTION: CORE ENGINES (COGNITIVE / WORK)
# ========================================
...
# ========================================
# SECTION: STABILITY SPINE ENGINES
# ========================================
...
# ========================================
# SECTION: PLUGINS (ADD-ON MODULES)
# ========================================
...
#
# GPT RULE:
#   - Do NOT add new engines/plugins here without confirming with Andrew.
#   - If a new subsystem idea emerges, ASK:
#       "Should this be a core engine or a plugin entry in MODULES?"
